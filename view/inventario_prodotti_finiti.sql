...
CREATE OR REPLACE FORCE EDITIONABLE VIEW "C##COMET"."INVENTARIO_PRODOTTI_FINITI" ("CODICEPRODOTTO", "NOMEPRODOTTO", "QUANTITAPRODOTTA", "QUANTITACALENDARIZZATA", "QUANTITAVENDUTA", "QUANTITARIMANENTE") AS 
  SELECT
	p.CODICEPRODOTTO, 
	p.NOMEPRODOTTO, 
