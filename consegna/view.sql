...
LEFT JOIN (
	...
	JOIN PRODOTTOFINITO p ON p.CODICEPRODOTTOFINITO = c.CODICEPRODOTTOFINITO 
...
LEFT JOIN (
	...
	FROM CALENDARIOPRODUZIONE c
	JOIN PRODOTTOFINITO pf ON pf.CODICEPRODOTTOFINITO = c.CODICEPRODOTTOFINITO
	JOIN FORMULA f ON f.CODICEPRODOTTOFINITO = pf.CODICEPRODOTTOFINITO
